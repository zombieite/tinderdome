    ...
    public function the_board()
    {
        ...
        [
            ...
            [
                'title' => 'Norwood',
                'location' => 'Norwood',
                'summary' => "It's Christmas eve. Snow. Building cars. But wait, we need to stop the lines again. Hundreds of people who would prefer to be working have to fight off the Hellies and Gillies. FB groans, is it the communists or the fascists? Laura says I can't remember which is which. FB mentions at least they hate each other so much that they will never team up. No DT to be seen, and DT is their best pilot, so the battles haven't been going so well lately. All the other pilots refuse to fly Easy Money, it's too big and dangerous. And they're almost out of ammo. But everyone gives up fighting for the night because it's Christmas eve.",
                'answered_question' => '',
                'new_question' => '',
            ],
            1 => 
