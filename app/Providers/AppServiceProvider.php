...
class AppServiceProvider extends ServiceProvider
{
    public function boot()
    {
        View::composer('*', function($view) {
            ...
            $logged_in_user_missions_completed     = null;
            $title                                 = null;
            if ($logged_in_user_id && $logged_in_user) {
                ...
                $logged_in_user_missions_completed = \App\Util::missions_completed($logged_in_user_id);
            ...
            $view->with('logged_in_user_missions_completed', $logged_in_user_missions_completed);
            $view->with('logged_in_user_title',              $title);
        });
    }
}
