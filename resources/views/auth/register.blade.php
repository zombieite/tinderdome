...
<p style="margin-left: 2em; margin-top: 0em; margin-bottom: 0em;">
	...
	<label for="share_info_with_favorites">Share my email address with mutual "Fuck yeah" ratings.</label> You must also check "Open to finding a new romantic partner" above. This allows you to contact other users directly without having to be matched to them at events.
</p>
