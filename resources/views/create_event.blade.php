...
<h1>{{ $is_editing ? 'Edit event' : 'Create an event' }}</h1>
...
<form action="" method="POST">
    ...
    <input id="event_long_name" type="text" name="event_long_name" size="50" maxlength="50" value="{{ $event_long_name }}" required>
    ...
    <input id="event_class" type="text" name="event_class" size="50" maxlength="50" value="{{ $event_class }}" required>
    ...
    <input id="url" type="url" name="url" size="50" maxlength="255" value="{{ $url }}">
    ...
    <textarea rows="10" name="description" id="description">{{ $description }}</textarea>
    ...
    <input id="bounty_hunt" name="bounty_hunt" type="checkbox" @if ($bounty_hunt) checked @endif>
    ...
    @if ($logged_in_user_can_create_public_missions)
        ...
        <input id="public" name="public" type="checkbox" @if ($public) checked @endif>
    ...
    <br><br>
    <button id="submit" type="submit" class="yesyes">{{ $is_editing ? 'Save event' : 'Create event' }}</button>
