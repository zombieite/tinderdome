...
@if ($attending_next_event)
	...
	@else
		...
		@else
			<li>Matches have not yet been run for {{ $pretty_names[$next_event] }} {{ $year }}. Check back here a few days before the next event to find out who you've been matched with.</li>
		@endif
	@endif
@else
