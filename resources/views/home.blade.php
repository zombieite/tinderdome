...
@else
	...
	@if ($number_photos)
		@if (count($unrated_users) >= 3)
			...
			@endfor
		@else
<h2><a href="https://www.facebook.com/YouAreAwaited" class="bright">Follow You Are Awaited on Facebook</a> so we don't have to email you updates about random stuff.</h2>
{{--
