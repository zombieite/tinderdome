...
<p>
Upon mission completion, you can go to the WCC Post Office to pick up your caps. Or, at Atomic Falls, find <a href="/profile/34/Blank">Blank</a>. Every mission you complete earns you a different cap. <a href="{{ route('register') }}">Get started by creating your profile</a>.
</p>
@endsection
