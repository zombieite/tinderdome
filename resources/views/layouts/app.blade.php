...
<link href="{{ env('APPEARANCE') === 'neo' ? '/css/neo.css' : '/css/yaa.css' }}" rel="stylesheet">
</head>
<body>
<a href="{{ url('/') }}" style="text-decoration:none;"><img src="{{ env('APPEARANCE') === 'neo' ? '/images/neo-header.png' : '/images/yaa-header.png' }}" style="filter:none;width:100%;max-width:530px;"></a>
<br>
@guest
