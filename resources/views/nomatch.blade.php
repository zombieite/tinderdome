...
@if ($logged_in_is_signed_up)
	...
	<p>
		...
		<ul>
			...
			<li>You signed up late and not enough people had time to rate your profile. The good news is, users at the <i>next</i> event will see your profile much sooner and you'll receive more ratings for the next event.</li>
		</ul>
	</p>
