<form action="{{ $action }}" method="POST">
	...
	@else
		<input type="submit" name="YesYesYes" value="{{ isset($curse_interface) ? 'Fuck yeah' : 'Heck yeah' }}"@if (($current_choice == 3) || !isset($current_choice)) class="yesyesyes"@else class="unselected_emoji_button" @endif>
