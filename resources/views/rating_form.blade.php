<form action="{{ $action }}" method="POST">
	...
	@if (isset($is_my_match) && $is_my_match)
		...
		&nbsp;&nbsp;&nbsp;
		<input type="submit" name="No" value="I found them but did not enjoy meeting them"@if (!isset($current_choice) || (isset($current_choice) && ($current_choice != -1))) class="no"@endif>
	@else
